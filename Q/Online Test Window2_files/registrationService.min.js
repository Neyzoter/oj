...
b=cn.neyzoter.test.getInvitationKey();if(!b)return a=p.defer(),a.reject({exception:"Invalid test key"}),a.promise;var c=p.defer();q.isResubmitRequested()?(n.log("This is resubmit request, returning old CRFs here"),g=B(g),a.CRFs=g,u(g)):a=y(b,a);c.resolve(a);return c.promise};this.preValidateCandidate=function(a, b, c){cn.neyzoter.test.getInvitationKey();var d={},f;angular.forEach(a,function(a){a.IsValidate&&(d[a.RegistrationFieldID]=a.value);1===a.RegistrationFieldID&&(f=a.value)});0!=x(d)||b?k.post(l.Url.candidatePreValidateCandidateUrl,
{ik:encodeURIComponent(cn.neyzoter.test.getInvitationKey()),e:f,f:d,cpik:encodeURIComponent(b)}).success(function(b, d, f, e){b.FieldsMap=b.FieldsMap||{};angular.forEach(a,function(a){var c=b.FieldsMap[a.RegistrationFieldID];c?a.error=window[c]||c:delete a.error});c(b.Success)}).error(function(a, b, d, f){c(!0)}):c(!0)};this.validateCandidateData=s;this.registerCandidate=function(a, b, c, d){s(a)&&k({method:"post",url:l.Url.candidateRegistrationUrl,data:w(a,b,d)}).success(function(a, b, d, e){c({status:b,data:a})}).error(function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        b, d, e){c({status:b,data:a})})};this.checkCandidateForIdleState=function(){return k({url:l.Url.candidateStateUrl+"?c\x3d"+encodeURIComponent(cn.neyzoter.test.getCandidateKey())+"\x26_\x3d"+(new Date).getTime(),method:"GET"})};this.sendResumeRequest=function(){return k.post(l.Url.resumeRequestUrl,{c:encodeURIComponent(cn.neyzoter.test.getCandidateKey())})};this.populateCRFValuesForApiCandidate=function(a, b){angular.forEach(a,function(a){var d=b.fieldValues[a.RegistrationFieldID],f=!e.isEmpty(d)&&"null"!=d;a.HidePrefilled=
