define2(["services/testWindowFactory","services/testWindowCommonUtils"],function(){angular.module("mettl").register.controller("ResultCtrl",["$scope","$http","$window","$log","$state","$timeout","TestWindowFactory","TestWindowCommonUtils",function(a,m,r,f,g,e,d,n){function p(){var b=cn.neyzoter.test.isApi(),c=cn.neyzoter.test.isPrivateInviteLink(),h=cn.neyzoter.test.redirectUrl();a.showApiButton=(b||c)&&!(""==h||"/"==h)}function k(){window.location=cn.neyzoter.test.redirectUrl();a.redirecting=!0}function l(){0<a.remainingTime?(a.remainingTime--,
e(l,1E3)):k()}if(a.$parent.initialised){a.$parent.isTestWindow=!1;a.candidateScore={score:-1};a.errorOccurred=!1;a.resultAvailable=!1;a.testName=cn.neyzoter.test.getTestName();a.showReportLink=cn.neyzoter.test.getShowReportLink();a.showResult=cn.neyzoter.test.getShowResult();p();var q=cn.neyzoter.test.getCandidateInstanceId();a.getCandidateResult=function(){m.get("/getCandidateResult?ciId\x3d"+q+"\x26flex\x3d"+Number(new Date)).success(function(b, c, d, f){c=b.candidateScore;a.candidateScore=c;b&&c&&c.assessmentScore&&(a.candidateScore.assessmentScore=
