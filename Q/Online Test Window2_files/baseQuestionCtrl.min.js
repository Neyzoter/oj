...
(f.success<e.total&&(f.success++,f.completed++,this.images[g].loaded=!0),f.completed==e.total&&a.$emit(l.Events.Question.QuestionImagesLoaded)):x(function(){G.loadImage(d,function(){f.success<e.total&&(f.success++,e.images[g].loaded=!0);b()},function(){f.error++;H.test.isPreview()||a.items[c].questionImages.informed||1!=a.items[c].questionImages.counter.reloads||(M.post(l.Url.informSupport,{ck:H.test.getCandidateKey(),reason:"loadFailure",type:"image",s:k.sectionState.currentIndex,i:k.itemState.currentIndex}),
