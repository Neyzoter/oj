...
qNumber:g(a.$state.params.i)+1,filter:a.currentFilterName}});for(var e=0,e=d-1;0<=e;e--)if(d=h.sections.getByIndex(e),!d.IsComplete()||!d.IsTimed){b=e;break}_.isUndefined(b)||a.changeSection(b)}};a.$on(c.Events.Section.ChangeSection,function(a,c,e){k.go("^.^.section",{s:g(c)})});a.askFinish=function(){t.isNavigationAllowed(c.NavigationAway.MANUAL_FT).then(function(){if(A.canFinishCurrentSection("f")){var b=h.getAttemptSummary();b.isFixedSectionOrder=h.test.isFixedSectionOrder();b.isTaskBasedTest=
...
action:b,data:{qIndex:f.itemState.currentIndex,qNumber:f.itemState.currentIndex+1}})}});a.$emit(c.Events.Test.AskFinish,{category:"buttonRR",action:"finishTestMain",data:{qIndex:g(a.$state.params.i),qNumber:g(a.$state.params.i)+1,filter:a.currentFilterName}})}})["catch"](function(a){q.error("Finish test not allowed. Error: ",a)})};a.saveTask=function(){var b=C.defer();t.isNavigationAllowed(c.NavigationAway.QUESTION).then(function(){var b=h.getAttemptSummary();b.isFixedSectionOrder=h.test.isFixedSectionOrder();
