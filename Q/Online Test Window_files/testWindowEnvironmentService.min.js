...
y.getTime())/1E3/60);$("#last-saved").html(a);setTimeout(C,6E4)}function M(){var a=$("#testTimeBox"),b=$("#notification-wrapper");a.addClass("about-to-finish pull-left");b.slideDown();setTimeout(function(){b.slideUp();a.css("text-decoration","none")},1E4)}function r(a){f.syncParent("testFinished",{});b.testState.showResult||b.testState.showReport?K.go(d.Url.resultPageUrl):setTimeout(function(){t.test.isMSB()?""!=b.redirectUrl&&"/"!=b.redirectUrl?L.sendMessage({clientId:b.candidate.clientId,link:b.redirectUrl,
...
l.softwareName+" running on your computer. This implies that you were cheating hence we are ending your test.\x3c/p\x3e"),e.softwareName=l.softwareName}k.log("Ending Test : type- "+e.dialogueType+" priority- "+e.dialoguePriority);b.testState.isPreview?(q(e),setTimeout(function(){f.closeWindow()},3E3)):($(".chatOutCont").hide(),w.updateTimeTakenForSection(b.sectionState.current),I.saveLastItem(),s(),h.$broadcast("test.shutdown"),q(e),f.syncParent("testFinished",e))})["catch"](function(a){k.error("Navigation not allowed in case of Auto FT. Error: ",
