...
u;a.submitRegistration=function(){a.isProcessingCRFs=!0;k.validateCandidateData(a.CRFs)?k.preValidateCandidate(a.CRFs,a.opts.candidatePrivateInviteKey,function(b){b?k.registerCandidate(a.CRFs,a.ConsentId,function(a){l.test.setCandidateKey(a.data.ciid);switch(a.status){case 200:u(a);break;case 500:g.go("error");break;default:t(a)}},a.opts.candidateContextData):a.isProcessingCRFs=!1}):a.isProcessingCRFs=!1};a.range=function(a,d,c){c=void 0===c?1:c;for(var e=[];a<=d;a+=c)e.push(a);return e};a.$on("$destroy",
