...
"TestWindowFactory","TestWindowCommonUtils","CodeQuestionService","$interval","TestWindowConstants",function(b,s,r,w,y,t,ca,z,ya,D,A,Q,E,da,d,R,ea){function S(){b.isPreview=cn.neyzoter.test.isPreview();try{H=JSON.parse(TEST_CODE_TEXT_8)}catch(a){H=TEST_CODE_TEXT_8}try{I=JSON.parse(TEST_CODE_TIMED_OUT)}catch(n){I=TEST_CODE_TIMED_OUT}b.expandWindow=!1;b.intellisense=!0;D(function(){b.monacoEditor.changeEditorSettings("intellisense",b.intellisense)});b.languages=d.getLanguageObjectForUi();b.editorData=d.getEditorSettings();
